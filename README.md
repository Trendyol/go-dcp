...
| `dcp.group.membership.couchbase.expiryDuration`             |   time.Duration   |    no    |    2000    | Set this if membership is `couchbase`. Expire duration of membership document.                                      |
| `dcp.group.membership.couchbase.heartbeatInterval`          |   time.Duration   |    no    |    1000    | Set this if membership is `couchbase`. Heartbeat period of members                                                  |
| `dcp.group.membership.couchbase.heartbeatToleranceDuration` |   time.Duration   |    no    |    2000    | Set this if membership is `couchbase`. Heartbeat tolerance duration of members                                      |
| `dcp.group.membership.couchbase.monitorInterval`            |   time.Duration   |    no    |    500     | Set this if membership is `couchbase`. Monitor Interval of members                                                  |
| `dcp.group.membership.couchbase.timeout`                    |   time.Duration   |    no    |   10000    | Set this if membership is `couchbase`. Timeout duration of couchbase connection                                     |
