...
| `dcp.group.membership.couchbase.expiryDuration`             |   time.Duration   |    no    |     2s     | Set this if membership is `couchbase`. Expire duration of membership document.                                      |
| `dcp.group.membership.couchbase.heartbeatInterval`          |   time.Duration   |    no    |     1s     | Set this if membership is `couchbase`. Heartbeat period of members                                                  |
| `dcp.group.membership.couchbase.heartbeatToleranceDuration` |   time.Duration   |    no    |     2s     | Set this if membership is `couchbase`. Heartbeat tolerance duration of members                                      |
| `dcp.group.membership.couchbase.monitorInterval`            |   time.Duration   |    no    |   500ms    | Set this if membership is `couchbase`. Monitor Interval of members                                                  |
| `dcp.group.membership.couchbase.timeout`                    |   time.Duration   |    no    |    10s     | Set this if membership is `couchbase`. Timeout duration of couchbase connection                                     |
