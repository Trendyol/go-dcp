...
func (c *Dcp) applyDefaultGroupMembership() {
	...
	if totalMembersFromEnvVariable := os.Getenv("totalMembers"); totalMembersFromEnvVariable != "" {
	...
	if memberNumberFromEnvVariable := os.Getenv("memberNumber"); memberNumberFromEnvVariable != "" {
